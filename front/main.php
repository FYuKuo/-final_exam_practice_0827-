<div class="news_btns d-f">
    <div class="new_btn activeBtn" onclick="showNews(1,this)">健康新知</div>
    <div class="new_btn" onclick="showNews(2,this)">菸害防制</div>
    <div class="new_btn" onclick="showNews(3,this)">癌症防治</div>
    <div class="new_btn" onclick="showNews(4,this)">慢性病防治</div>
</div>
<div class="news_lists">
    <div class="new_list activeNew" data-id="1">
        <h1>健康新知</h1>
...
<script>
    function showNews(id,e){
        $('.new_list').removeClass('activeNew');
        $('.new_btn').removeClass('activeBtn');

        $('.new_list').each((key,val)=>{
            if($(val).data('id') == id){
                $(val).addClass('activeNew');
